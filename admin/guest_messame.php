    ...
    <div class="container py-5">
        ...
        <div class="col">
            ...
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Guest Message</li>
            </ol>
            </nav>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Guest Name</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="text-muted mb-0 title text-capitalize"><?= $after_assoc['gusest_name']?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0 title text-capitalize"><?= $after_assoc['guest_email']?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Guest Subject</p>
                            </div>
                            <div class="col-sm-9">
