          ...
          <div class="col-md-12">
            <div class="owl-testimonials owl-carousel">
              ...
              <div class="testimonial-item">
                ...
                <img src="fontend/http://placehold.it/60x60" alt="">
              </div>
              ...
              <form id="contact" action="admin/guest_message_post.php" method="post">
                <div class="row">
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="gusest_name" type="text" class="form-control" id="name" placeholder="Full Name" required >
                        
                    </fieldset>
                    <span class="text-danger" style="color:red;margin-bottom:-20px;">
                            <?php 
                                if (isset($_SESSION['gusest_name'])) {
                                    echo $_SESSION['gusest_name']; 
                                    unset($_SESSION['gusest_name']);
                                }
                            ?>
                        </span>
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_email" type="text" class="form-control" id="email" placeholder="E-Mail Address" required >
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_subject" type="text" class="form-control" id="subject" placeholder="Subject" required >
                        <span class="text-danger" style="color:red;">
                            <?php 
                                if (isset($_SESSION['guest_subject'])) {
                                    echo $_SESSION['guest_subject']; 
                                    unset($_SESSION['guest_subject']);
                                }
                            ?>
                        </span>
                    </fieldset>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="guest_mesage" rows="6" class="form-control" id="message" placeholder="Your Message" required ></textarea>
                        <span class="text-danger" style="color:red;">
                            <?php 
                                if (isset($_SESSION['guest_mesage'])) {
                                    echo $_SESSION['guest_mesage']; 
                                    unset($_SESSION['guest_mesage']);
                                }
                            ?>
                        </span>
                    </fieldset>
